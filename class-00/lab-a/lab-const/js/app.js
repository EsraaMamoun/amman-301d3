...
function displayPics(){
  ...
  // The const is a block-scope also like let, and we can't change it to another value so we can't use const in for statement becuse we need to change the values over and over again.
  console.log(viewed);
